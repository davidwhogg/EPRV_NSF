...
That is, to build flexible models with capacity tuned to
...
Given the fundamental astronomy and physics issues at stake, it seems obvious that this
proposal is relevant to \acronym{AAG}!
...
methods are best suited. We are not promising to fully
``solve'' stellar spectral variability; much of our work will be 
experimental. But this is also more than a series of experiments. 
