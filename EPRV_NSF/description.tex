...
We will revisit this with real data:
The \EXPRES\ Project has given us data from an asteroseismic campaign
on BEDELL WHAT STAR?
The \HARPS\ Archive includes
asteroseismic campaigns.
These short p-mode-relevant exposures n
can be empirically coadded into different
...
\noindent
Because we have access to proprietary \EXPRES\ data (from Debra Fischer at Yale; see letter of support)
...
but how to updatewithout seeming like we're asking for money for 
...
HOGG SAY STUFF ABOUT BEDELL SUPPORT HERE.
