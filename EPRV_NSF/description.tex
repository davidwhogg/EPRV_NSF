...
($1\,\mps$). 
\footnote{There are rumors that the \acronym{ESO} spectrograph
...
%Furthermore, the frequencies are known,
...
%In this case, the stellar \RV\ measurement relevant to exoplanet detection and
...
% I'm taking out flares because I don't think they're a big deal for the
% stars we're tackling!
\item
...
And the astronomical community is rally around this goal: many new \EPRV\ instruments 
are coming online, and NASA and NSF are jointly exploring future possibilities via the 
\project{\EPRV Working Group} (in which Co-I Bedell is involved).
