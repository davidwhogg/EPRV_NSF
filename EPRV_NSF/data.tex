...
\project{GitHub} and \project{GitLab} platforms. These repositories
...
data on versioned and mirrored \project{Github} and \project{GitLab}
...
\project{Zenodo} for preservation and creation of a lasting and
cite-able DOI. All documents and papers will be submitted to the
\project{arXiv} and also AAS-family journals for long-term
